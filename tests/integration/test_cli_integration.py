...
class TestCLIRegressionTests:
    ...
    def test_notes_command_no_recursion_bug(self, cli_runner, temp_storage_dir, populated_manager):
    ...
    def test_reversed_function_fix(self, cli_runner, temp_storage_dir, populated_manager):
